...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile sidebar */}
      <div
        className={`fixed left-0 top-0 h-screen w-80 glass-card border-r border-white/10 z-50 rounded-none transform transition-transform duration-300 md:hidden ${
          ...
          <nav className='flex-1 p-4 space-y-2 overflow-y-auto'>
            ...
            >
              <svg
                ...
                className={`w-6 h-6 ${pathname === '/dashboard/library' ? 'text-blue-400' : ''}`}
              >
            ...
            >
              <Users
                className={`w-6 h-6 ${pathname === '/dashboard/affiliates' ? 'text-blue-400' : ''}`}
              />
      ...
      {/* Desktop sidebar */}
      <div
        className={`fixed left-0 top-0 h-screen ${collapsed ? 'w-16' : 'w-64'} glass-sidebar border-r border-white/10 z-50 rounded-none transition-all duration-300 hidden md:block`}
      >
        <div className='flex flex-col h-full'>
          {/* Header */}
          <div className='p-6 border-b border-white/10'>
          ...
          <nav className='flex-1 p-4 space-y-2 overflow-y-auto'>
            ...
            >
              <svg
                ...
                strokeLinecap='round'
                strokeLinejoin='round'
                className={`w-5 h-5 ${pathname === '/dashboard/library' ? 'text-blue-400' : ''}`}
              >
                <path d='M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z'></path>
                <path d='M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z'></path>
              </svg>
            ...
            >
              <Users
                className={`w-5 h-5 ${pathname === '/dashboard/affiliates' ? 'text-blue-400' : ''}`}
              />
