    ...
    try {
      ...
      const response = await fetch('/api/ai/chat', {
        ...
        body: JSON.stringify({
          ...
          model: selectedModel,
          modelVariant:
            selectedModel === 'claude' ? 'claude-3-5-sonnet-20241022' : 'gpt-4',
        }),
      });
        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <p className='mt-1' style={{ color: 'var(--text-secondary)' }}>
              Advanced AI development and interaction platform
            </p>
          </div>
                  ...
                  {models.map(model => (
                    ...
                    >
                      <div className='flex items-center justify-between mb-4'>
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full border capitalize ${getModelStatusColor(model.status)}`}
                        >
                          {model.status}
                        </span>
                      </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        'Automatically optimize and tag uploaded images',
                      status: 'active',
                      runs: 1456,
                    ...
                    },
                    {
                      ...
                      description:
                        'AI-powered email responses for customer inquiries',
                      status: 'paused',
                      runs: 89,
                      lastRun: '1 day ago',
                    },
              ...
              <div className='glass-card p-6'>
                ...
                <div className='bg-white/5 border border-white/10 rounded-xl p-8 text-center'>
                  ...
                  <p className='text-gray-400 mb-6'>
                    Drag and drop interface for creating complex AI-powered
                    automations
                  </p>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
