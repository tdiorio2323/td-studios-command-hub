-- TD STUDIOS ULTIMATE - CLEAN DATABASE SETUP
-- This handles existing tables/policies without conflicts

-- Step 1: Create tables (IF NOT EXISTS prevents conflicts)
...
-- Step 4: Create indexes (IF NOT EXISTS prevents conflicts)
...
-- Step 5: Create functions (OR REPLACE handles existing functions)
...
-- Success message
SELECT 'TD Studios Ultimate Database Setup Complete!' as status;
